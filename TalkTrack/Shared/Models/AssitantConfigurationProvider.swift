//
//  AssitantConfigurationProvider.swift
//  TalkTrack
//
...
class AssistantConfigurationProvider {
   ...
   func listAssistants() async throws {
      do {
   ...
   func createAssistant(parameters: AssistantParameters) async throws {
      do {
   ...
   func createAvatar(prompt: String) async throws {
      do {
